...
public enum ErrorMsg {
  ...
  ERROR_DATOS_VACIOS("0002", "%s", ErrorCause.REGLANEGOCIO),
  ERROR_NO_DATOS_BUSQUEDA_USUARIOS("0003",
      "Error, debes de proporcionar al menos el id de usuario, correo, o nombre para la búsqueda",
      ErrorCause.REGLANEGOCIO),
  ERROR_USUARIO_NO_ENCONTRADO("0004", "El usuario o la contraseña son incorrectos.",
      ErrorCause.REGLANEGOCIO),
  ERROR_USUARIO_ACTIVO("0005", "El usuario tiene una sesión activa.",
      ErrorCause.REGLANEGOCIO),
  ERROR_INICIO_SESION_TOKEN("0006",
      "Ocurrió un error al generar token de inicio de sesión, favor de reportarlo al administrador.",
      ErrorCause.CODIGO),
  ERROR_TOKEN_NO_VALIDO("0007", "El token proporcionado no es válido.",
      ErrorCause.REGLANEGOCIO),
  ERROR_TOKEN_VACIO("0008", "Debes de proporcionar un token para la consulta del servicio.",
      ErrorCause.REGLANEGOCIO),
  ERROR_CIERRE_SESION("0009",
      "Ocurrió un error al cerrar la sesión, favor de reportarlo al administrador.",
      ErrorCause.CODIGO),
  ERROR_RESPUESTA_INCORRECTA("0010", "La pregunta o la respuesta es incorrecta.",
      ErrorCause.REGLANEGOCIO),
  ERROR_CORR_PRERES_INCORREC("0011", "El correo de usuario o la pregunta y respuesta son incorrectos.",
      ErrorCause.REGLANEGOCIO),
  ERROR_NO_USUAIRO_ENCONTRADO("0012", "No se encontraron usuarios.",
      ErrorCause.REGLANEGOCIO),
  ERROR_LLAVE_UNICA_CUSTOM("0015",
      "Se ha enviado un id de llave foranea que no existe para el campo (%s).",
      ErrorCause.REGLANEGOCIO),
  ERROR_PASS_GENERATE("0016",
      "Error generando password, favor de reportarlo con el administrador del sistema.",
      ErrorCause.CODIGO),
  ...
  ERROR_LLAVE_FORANEA("0022",
      ...
      ErrorCause.CODIGO),
  ERROR_TABLE_NOT_EXIST("0023",
      "Error, la tabla consultada no existe,"
      + " favor de reportarlo con el administrador del sistema.",
      ErrorCause.CONFIGURACION),
